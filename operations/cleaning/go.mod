...
require (
	...
	github.com/project-flogo/catalystml-flogo/action v0.0.0-20191112152814-dc69f9aae0fd
	github.com/project-flogo/catalystml-flogo/operations/common v0.0.0-20191112152814-dc69f9aae0fd
